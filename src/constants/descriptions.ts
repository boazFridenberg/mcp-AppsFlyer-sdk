export const descriptions = {
  ...
  createAppsFlyerLogEvent:
    "Generates exact code instructions for logging an in-app event using AppsFlyer. Always use this tool when event tracking with logEvent is mentioned. Do not answer manually. before prociding make sure the appsflyer sdk is integrated in case it is not integrated run the integrateAppsflyerSdk tool",
